...
const about_content = {
    img_1: "/assets/img/about/prod.jpg",
    img_2: "/assets/img/about/dj_.jpg",
    img_3: "/assets/img/about/law-icon.png",
    img_4: "/assets/img/about/djeco.png",
    img_5: "/assets/img/about/signature-bg.png", 

    left_title: "Designing the Future",
    title: <>about the <br /> TJProduction team agency</>,
    about_P_title: <>We help you in visibility and branding authority</>,
    des: <>We provide creative and customized design solutions to help businesses effectively communicate their brand message and stand out in their industry</>,
}
...
const about_feature_data = [
    ...
    },
    {
        ...
        text: <>Tailored Custom <br /> Design</>
    },
]
                            ...
                            <div className={`law-icon ${style_about && "law-icon-text"}`}>

                                {
                                    ...
                                    <div className="d-inline-block p-relative">
                                        <div>
                                            <img src="/assets/img/about/dj_.png" alt="" />
                                        </div>
                                ...
                                <div className="row align-items-center">
                                    <div className="col-sm-8 col-12 wow tpfadeUp">
                                        <div className="law-ab-avata-box d-flex align-items-center">
                                            ...
                                            <div className="law-ab-author-head">
                                                <span className={`${style_about && "cornblue-text-color"}`}>CEO, Designer</span>
                                                <h4 className={`law-ab-auther-name ${style_about && "text-black"}`}>Djeffson Thelusma</h4>
                                            </div>
                                        </div>
                                    ...
                                    <div className="col-sm-4 d-none d-sm-block wow tpfadeUp" data-wow-delay=".4s">
                                        <div className="law-author-signature text-end">
                                            {
                                                style_about && <img src="/assets/img/about/signature-bg.png" alt="" />
                                            }
                                            {/* <img src={img_5} alt="" /> */}
                                        </div>
                                    </div>
