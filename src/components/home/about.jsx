        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <Tilt
              ...
              >
                <img src="/assets/img/about/tj-about.jpg" alt="about-img" />
              </div>
              </Tilt>
                  ...
                  <ul>
                    <li>
                      <span>
                       ...
                       We Offer custom design solutions tailored to each client's needs
                    </li>
                    <li>
                      <span>
                        <i className="fal fa-check"></i>
                      </span>
                      We take times to understand each client's vision, goals, and target audience
                    </li>
                  </ul>
                </div>
