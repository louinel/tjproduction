                            ...
                            <div className="tp-footer__widget mb-40">
                                ...
                                <div className="tp-footer-cta d-flex align-items-center mb-30">
                                    <span className="call-icon"><img src="/assets/img/footer/footer-rbg-call.png"
                                            alt="" /></span>
                                    <span>
                                         <span className="d-block mb-0">Padre de las Casas, Santiago</span>
                                        <b><a href="callto:+18094168944"> Call Us: +1 (809) 416-8944 </a></b>
                                    </span>
                                </div>
                                <div className="tp-footer-cta d-flex align-items-center mb-30">
                                    <span className="call-icon"><img src="/assets/img/footer/message-rgb-ison.png"
                                            alt="" /></span>
                                    <span>
                                        <b><a href="mailto:info@tjproduction.design"> info@tjproduction.design </a></b>
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-xl-4 col-md-6">
                            <div className="tp-footer__widget bs-pl-60 mb-40">
                                ...
                                <div className="da-ft-social">
                                    <b> Connect Here:</b>
                                    <span> <a href="https://www.facebook.com/profile.php?id=100063916820130"><i className="fab fa-facebook-f"></i></a></span>
                                    <span> <a href="https://www.instagram.com/tjproduction22/"><i className="fab fa-instagram"></i></a></span>
                                </div>
                            </div>
                        </div>
