          ...
          <div className="row">
            <div className="col-lg-5">
              <div className="da-hero-section mt-40">
                <span className="da-hero-section__subtitle white-bg mb-15 d-inline-block wow tpfadeUp">
                  Digital Experience In <b> Stgo </b>
                </span>
                <div className="cd-intro">
                  <h3
                    ...
                    data-wow-delay=".3s"
                  >
                    <span>Solid design experiences is that </span>
              ...
              <div
                ...
                data-wow-delay=".3s"
              >
                <Link href="/services" className="tp-grd-btn">
                  Our Services
              ...
              <div
                ...
                data-wow-delay=".5s"
              >
                <Link href="/portfolios" className="tp-grey-btn">
                  Case study
                  <span className="ml-10">
                    <i className="fal fa-long-arrow-right"></i>
                    <i className="fal fa-long-arrow-right"></i>
            ...
            <Tilt
              ...
              <div className="tp-da-hero-img text-end pr-30">
                <img src="/assets/img/hero/tj-hero.jpg" alt="" />
              </div>
              <div className="da-hero-black-box bg-black float-end">
                <span>
                  <a href="mailto:info@tjproduction.design">info@tjproduction.design</a>
                </span>
                <span className="float-end">
                  <a href="mailto:info@tjproduction.design">
